...
public class P2SHTransactionECDSASigner {
    ...
    public static void signNestedSegwit(Transaction transaction, PrivateKey privateKey, int index, Script redeemScript, BigInteger amount) throws IOException, NoSuchAlgorithmException {
    ...
    private static String getSigHash(Transaction transaction, int index, Script redeemScript, BigInteger amount, boolean isSegwitInput) throws NoSuchAlgorithmException, IOException {
        if (isSegwitInput) {
